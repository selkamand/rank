...
Conduct](https://github.com/selkamand/rank/blob/dev/CODE_OF_CONDUCT.md).
...
[Issues](https://github.com/selkamand/rank/issues) that might help you.
...
- Use the template
  [other_issue.md](https://github.com/selkamand/rank/blob/dev/.github/ISSUE_TEMPLATE/other_issue.md).
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/selkamand/rank/issues?q=label%3Abug).
...
- Open a new [Issue](https://github.com/selkamand/rank/issues/new).
- Use the template
  [bug_report.md](https://github.com/selkamand/rank/blob/dev/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Make sure that you are using the latest version of `rank`.
- Read the [documentation](https://github.com/selkamand/rank/) carefully
  and find out if the functionality is already covered.
- Perform a [search](https://github.com/selkamand/rank/issues) to see if
  this enhancement has already been suggested. If it has, add a comment
  to the existing issue instead of opening a new one.

### How do I submit a feature request?

Feature requests are tracked as [GitHub
Issues](https://github.com/selkamand/rank/issues).

- Open a new [Issue](https://github.com/selkamand/rank/issues/new).
- Use the template
  [feature_request.md](https://github.com/selkamand/rank/blob/dev/.github/ISSUE_TEMPLATE/feature_request.md).
...
7.  Submit a [Pull
    ...
    on the [original repo](https://github.com/selkamand/rank/compare).
