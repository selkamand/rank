...
First off, thanks for taking the time to contribute to `rank`!
...
[Contributor Code of Conduct](https://github.com/selkamand/rank/blob/dev/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report 
unacceptable behavior to <selkamand@ccia.org.au>.
...
`rank` uses the `lower_snake_case`.
...
[Issues](https://github.com/selkamand/rank/issues) that might help 
...
- Open a new [Issue](https://github.com/selkamand/rank/issues/new).
- Use the template [other_issue.md](https://github.com/selkamand/rank/blob/dev/.github/ISSUE_TEMPLATE/other_issue.md).
...
- Make sure that you are using the latest version of `rank`.
- Determine if your bug is really a bug and not an error on your side.
- To see if other users have experienced (and potentially already solved) the 
same issue you are having, check if there is not already a bug report existing 
for your bug or error in the [bug tracker](https://github.com/selkamand/rank/issues?q=label%3Abug).



### How do I submit a bug report?

We use [GitHub Issues](https://github.com/selkamand/rank/issues) to 
track bugs and errors. If you run into an issue with the project:

- Open a new [Issue](https://github.com/selkamand/rank/issues/new).
- Use the template [bug_report.md](https://github.com/selkamand/rank/blob/dev/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Make sure that you are using the latest version of `rank`.
- Read the [documentation](https://github.com/selkamand/rank/)
carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/selkamand/rank/issues) to 
...
[GitHub Issues](https://github.com/selkamand/rank/issues).

- Open a new [Issue](https://github.com/selkamand/rank/issues/new).
- Use the template [feature_request.md](https://github.com/selkamand/rank/blob/dev/.github/ISSUE_TEMPLATE/feature_request.md).
- Provide a clear and descriptive title for the issue to identify the suggestion.
- Provide a step-by-step description of the suggested enhancement in as 
many details as possible.
- Explain why this enhancement would be useful to most `rank` users.
...
3. Submit a [Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) on the [original repo](https://github.com/selkamand/rank/compare).
